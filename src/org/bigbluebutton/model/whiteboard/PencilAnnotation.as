package org.bigbluebutton.model.whiteboard
{
	...
	public class PencilAnnotation extends Annotation
	{
		...
		public function PencilAnnotation(type:String, anID:String, presentationID:String, pageNumber:int, status:String, color:Number, thickness:Number, transparency:Boolean, points:Array)
		{
