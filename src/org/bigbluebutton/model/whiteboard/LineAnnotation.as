package org.bigbluebutton.model.whiteboard
{
	...
	public class LineAnnotation extends Annotation
	{
		...
		public function LineAnnotation(type:String, anID:String, presentationID:String, pageNumber:int, status:String, color:Number, thickness:Number, transparency:Boolean, points:Array) {
