package org.bigbluebutton.model.whiteboard
{
	...
	public class EllipseAnnotation extends Annotation {
		...
		public function EllipseAnnotation(type:String, anID:String, presentationID:String, pageNumber:int, status:String, color:Number, thickness:Number, transparency:Boolean, points:Array, circle:Boolean) {
