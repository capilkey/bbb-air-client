package org.bigbluebutton.model.whiteboard 
{
	...
	public class TriangleAnnotation extends Annotation {
		...
		public function TriangleAnnotation(type:String, anID:String, presentationID:String, pageNumber:int, status:String, color:Number, thickness:Number, transparency:Boolean, points:Array) {
