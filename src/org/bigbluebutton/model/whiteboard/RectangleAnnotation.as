package org.bigbluebutton.model.whiteboard
{
	...
	public class RectangleAnnotation extends Annotation {
		...
		public function RectangleAnnotation(type:String, anID:String, presentationID:String, pageNumber:int, status:String, color:Number, thickness:Number, transparency:Boolean, points:Array, square:Boolean) {
			super(type, anID, presentationID, pageNumber, status, color);
